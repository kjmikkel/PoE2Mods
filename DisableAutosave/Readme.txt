...
:: FEATURES ::
This mod disables all the autosave functionality.
...
::  CREDITS ::
This is a lightly modified version of a mod made by SonicZentropy (and its original source can be found here: https://github.com/SonicZentropy/PoE2Mods.pw).

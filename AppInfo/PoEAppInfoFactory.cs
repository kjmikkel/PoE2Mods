...
namespace PoEGameInfo
{
    ...
    internal class PoEAppInfoFactory : AppInfoFactory
    {
        public override AppInfo CreateInfo(DirectoryInfo folderInfo)
        {
            ...
            {
                exeFileName = "PillarsOfEternityII";
                iconFile = "PillarsOfEternityII.png";
                appVersion = null;
            }
            else
            {
                exeFileName = iconFile = "PillarsOfEternityII.exe";
            ...
            {
                throw new FileNotFoundException($"The Pillars of Eternity: Deadfire executable file '{exeFileName}' was not found in this directory.", exeFileName);
            }

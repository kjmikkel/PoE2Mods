...
namespace ShipClickThroughFog
{
    // Ensure that the player can move by clicking on the fog - for original see https://github.com/SonicZentropy/PoE2Mods.pw
    [ModifiesType("Game.Player")]
    class mod_Player : Player
    {
        [DuplicatesBody("UpdateCursor")]
        public void orig_UpdateCursor() { }
        ...
        {
            if ((bool)WorldMapPlayer.Instance?.CanReachMousePosition())
            {
